...
speechoutput_en = {
    ...
    'select_player_nk': "Sorry, I didn't recognise a player name",
...
speechoutput_de = {
    ...
    'select_player_nf': "Ich kann nur die folgenden Geräte finden:\
                         {0}. Welches willst du?",
    'select_player_nk': "Tut mir leid, Ich habe keinen Playernamen gehört",
...
textoutput_de = {
    ...
    'play_playlist_none': "Keine Wiedergabeliste auf deiner Squeezbox \
                           gefunden",
